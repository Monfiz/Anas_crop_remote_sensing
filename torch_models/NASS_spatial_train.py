...
#save model
print("Saving model...")
PATH = "nice_models_results/NASS_spatial.pth"
...
plt.savefig('nice_models_results/loss_NASS_spatial.png')

plt.plot(list(range(len(lrs))), lrs)
plt.xlabel("Batches")
plt.ylabel("Learning rate")
plt.title("Evolution of Learning Rate")
plt.savefig('nice_models_results/lr_NASS_spatial.png')

with open("nice_models_results/list_loss_NASS_spatial.txt", 'w') as f:
    for s in mse_list:
        f.write(str(s) + '\n')
