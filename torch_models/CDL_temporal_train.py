...
#save model
print("Saving model...")
PATH = "nice_models_results/CDL_temporal.pth"
...
plt.savefig('nice_models_results/loss_CDL_temporal.png')

plt.plot(list(range(len(lrs))), lrs)
plt.xlabel("Batches")
plt.ylabel("Learning rate")
plt.title("Evolution of Learning Rate")
plt.savefig('nice_models_results/lr_CDL_temporal.png')

with open("nice_models_results/list_loss_CDL_temporal.txt", 'w') as f:
    for s in mse_list:
        f.write(str(s) + '\n')
